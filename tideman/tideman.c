...
void sort_pairs(void)
{
    for (int i = 0; i < pair_count - 1; i++)
    {
        ...
        for (int j = i + 1; j < pair_count; j++)
        {
            ...
            int strength_strongest = preferences[pairs[strongest_index].winner][pairs[strongest_index].loser];

            if (strength_j > strength_strongest)
            {
                strongest_index = j;
            }
        }
...
void lock_pairs(void)
{
    for (int i = 0; i < pair_count; i++)
    {
        ...
        // Verifica se adicionar cria ciclo
